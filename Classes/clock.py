...
hour_hand = Hour(window_x/2, window_y/2, current_time.hour)
...
class Minute:
    def __init__(self, x, y, minutes):
        ...
        self.y = y
        self.pos = minutes - 15
        self.offset = 60 - current_time.second #makes sure the minute hand only updates when second hand is at 12
    def move(self, seconds):
...
# Did the user click the window close button?
    ...
    for x in range(12):
        pygame.draw.line(screen, (0,0,0), (250 + 175*math.cos(2*math.pi*(x/12)), 250 + 175*math.sin(2*math.pi*(x/12))), (250 + 180*math.cos(2*math.pi*(x/12)), 250 + 180*math.sin(2*math.pi*(x/12))), 3)
